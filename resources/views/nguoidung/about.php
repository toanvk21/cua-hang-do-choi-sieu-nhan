...
<html lang="en" ng-app="myapp" ng-controller="mycontroller">
  ...
  <div class="py-1 bg-primary">
    ...
    <div class="hero-wrap hero-bread" style="background-image: url('upload/sanpham/panner1.png');">
    </div>

    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container" ng-repeat = "b in tintuc " >
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url('upload/sanpham/{{b.image}}');">
						<a href="/upload/sanpham/1.mp4" class="icon popup-vimeo d-flex justify-content-center align-items-center">
